...
//three values(tail, body, head).It is your job to re - arrange the array so that the animal is the right way round(head, body, tail).
...
const meerkatsArray = ['tail', 'body', 'head']
const fixedMeerkatsArray = fixTheMeerkat(meerkatsArray)
console.log(meerkatsArray)